...
function saveDetail(id) {
    ...
    var params = "id=" + <?php echo $_SESSION['user']['id']; ?> + "&" + id + "=" + updatedValue;
...
<div class="profile-container">
    <div class="profile-card">
        ...
        <div class="profile-info">
            <div class="avatar">
                <img id="profile-image" src="<?php echo htmlspecialchars($_SESSION['user']['image']); ?>" alt="Profile Picture">
            ...
            <h2><?php echo htmlspecialchars($_SESSION['user']['fname']) . " " . htmlspecialchars($_SESSION['user']['lname']); ?></h2>
        ...
        <div class="details">
            <div class="detail-row">
                ...
                <span id="fname"><?php echo htmlspecialchars($_SESSION['user']['fname']); ?></span>
                <a href="#" class="edit-link" id="fname-link" onclick="editDetail('fname', '<?php echo htmlspecialchars($_SESSION['user']['fname']); ?>')">Edit</a>
            </div>

            <div class="detail-row">
                <span>Last Name</span>
                <span id="lname"><?php echo htmlspecialchars($_SESSION['user']['lname']); ?></span>
                <a href="#" class="edit-link" id="lname-link" onclick="editDetail('lname', '<?php echo htmlspecialchars($_SESSION['user']['lname']); ?>')">Edit</a>
            </div>

            <div class="detail-row">
                <span>E-Mail</span>
                <span id="email"><?php echo htmlspecialchars($_SESSION['user']['email']); ?></span>
                <a href="#" class="edit-link" id="email-link" onclick="editDetail('email', '<?php echo htmlspecialchars($_SESSION['user']['email']); ?>')">Edit</a>
            </div>

            <div class="detail-row">
                <span>Mobile Number</span>
                <span id="mnumber"><?php echo htmlspecialchars($_SESSION['user']['mnumber']); ?></span>
                <a href="#" class="edit-link" id="mnumber-link" onclick="editDetail('mnumber', '<?php echo htmlspecialchars($_SESSION['user']['mnumber']); ?>')">Edit</a>
            </div>

            <div class="detail-row">
                <span>Password</span>
                <span id="password"><?php echo htmlspecialchars($_SESSION['user']['password']); ?></span>
                <a href="#" class="edit-link" id="password-link" onclick="editDetail('password', '<?php echo htmlspecialchars($_SESSION['user']['password']); ?>')">Edit</a>
            </div>
        </div>
    </div>
</div>
...
document.getElementById('delete-avatar-btn').onclick = function() {
    ...
    if (confirm("Are you sure you want to delete your profile picture?")) {
        ...
        xhr.send("id=" + <?php echo $_SESSION['user']['id']; ?>);
    }
};
</script>
</body>
