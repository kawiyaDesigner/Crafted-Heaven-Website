        ...
        <div class="users">
            ...
            <?php while($row = mysqli_fetch_assoc($result)): ?>
                <div class="user-card">         
                    ...
                    <p> <?php echo $row['mnumber']; ?></p>
                    <p> <?php echo $row['company']; ?></p>
                    <p> <?php echo $row['email']; ?></p>
                    <p> <?php echo $row['password']; ?></p>
                    <div class="button-container">
                    <a class="edit-btn" href="updateseller.php?id=<?php echo $row['id']; ?>">Edit</a>
                    <a class="delete-btn" href="sellerdelete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')">Delete</a> 
                    </div> 
                </div>
            <?php endwhile; ?>
        </div>
