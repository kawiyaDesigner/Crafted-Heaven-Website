        ...
        <div class="users">
            ...
            <?php while($row = mysqli_fetch_assoc($result)): ?>
                <div class="user-card">         
                    ...
                    <a class="edit-btn" href="updateuser.php?id=<?php echo $row['id']; ?>">Edit</a>
                    <a class="delete-btn" href="userdelete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')">Delete</a> 
                    </div> 
                </div>
            <?php endwhile; ?>
        </div>
